...
<div class="container col-md-8 col-md-2">
  <form method="POST" action="">
    <table width="200">
      <tbody>
        ...
        <tr>
          <input type="text" name="identificacion" class="form-control" value="<?php echo $identificacion; ?>" readonly><br />
        </tr>
        <tr>
        ...
        <tr>
          <input type="email" name="correo" class="form-control" value="<?php echo $correo; ?>"><br />
        </tr>
        <tr>
          <input type="date" name="fecha" class="form-control" value="<?php echo $fecha; ?>"><br />
        </tr>
        <tr>
          <select name="pais" class="form-control" value="<?php echo $pais; ?>">
        ...
        <tr>
          <select name="ciudad" class="form-control" value="<?php echo $ciudad; ?>">
        ...
        <tr>
          <div class='mb-3'>
            <select name="region" class="form-control" value="<?php echo $region; ?>">
      ...
      <br />
      <td><input type="submit" name="actualizar" class="btn btn-success btn-sm" value="Modificar"></td>
      <td><a href="registros.php?" class="btn btn-secondary btn-sm">Cancelar</a></td>
      <div>
  </form>
  ...
  if (isset($_POST['actualizar'])) {
    ...
    $actualizar_pais = $_POST['pais'];
    $actualizar_ciudad = $_POST['ciudad'];
    $actualizar_region = $_POST['region'];


    $query = "UPDATE normas SET nombres='$actualizar_nombres',apellidos='$actualizar_apellidos',identificacion='$actualizar_identificacion',telefono='$actualizar_telefono',direccion='$actualizar_direccion',correo='$actualizar_correo',fecha='$actualizar_fecha',pais='$actualizar_pais',ciudad='$actualizar_ciudad',region='$actualizar_region'  WHERE identificacion = '$actualizar_identificacion'";
    $res = sqlsrv_query($conn, $query);
